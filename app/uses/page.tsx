...
export default function UsesPage() {
	return (
		<section>
			<h1 className='font-semibold text-2xl mb-8 tracking-tighter'>here's my setup</h1>
			<div className='prose prose-neutral dark:prose-invert'>
				...
				<ul>
					<li>
						Editor: VSCode (<a href='https://gist.github.com/leerob/e7883ab35d900b8cbb684ac77e7c4703'>Settings / Extensions</a>)
					</li>
