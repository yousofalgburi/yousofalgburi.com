			...
			<section className='mx-auto w-full max-w-2xl space-y-8 print:space-y-4'>
				<div className='flex items-center justify-between'>
					<div className='flex-1 space-y-1.5'>
						...
						<p className='max-w-md text-pretty font-mono text-sm text-muted-foreground print:text-[12px]'>{RESUME_DATA.about}</p>
						<p className='max-w-md items-center text-pretty font-mono text-xs text-muted-foreground inline-flex gap-x-1.5 align-baseline leading-none hover:underline'>
				...
				<Section>
					...
					<p className='text-pretty font-mono text-sm text-muted-foreground print:text-[12px]'>{RESUME_DATA.summary}</p>
				</Section>
				<Section>
							...
							<Card key={education.school}>
								<CardHeader>
									<div className='flex items-center justify-between gap-x-2 text-base'>
										...
										<div className='text-sm tabular-nums text-gray-500'>Graduated in May {education.end}</div>
									</div>
								</CardHeader>
