    ...
    return (
        <section>
            ...
            <div className="prose prose-neutral dark:prose-invert">
                ...
                <h2 className="mb-1 text-xl font-medium tracking-tighter">Call Box</h2>
                ...
                <h2 className="mb-1 text-xl font-medium tracking-tighter">Call Box</h2>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Junior Developer, May 2022 — Nov 2023</p>
                <ul>
                    <li>
